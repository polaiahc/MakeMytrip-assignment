...
public class EmailableReporter implements IReporter {
    ...
    public void generateReport(List<XmlSuite> xml, List<ISuite> suites,
        ...
        try {
            ...
            m_out.println("<table width='100%' cellspacing='1' cellpadding='5'>"
                    ...
                    .getProperty("env") : "")
                    + " </b></td></tr><tr><td style='background-color: #ffffff;'><b>Excord Testplan : "
                    + (Boolean.parseBoolean(System.getProperty("postToexcord")) == true ? 
                    		"<a href='http://excord.deem.com/testplan_view?testplanId=" 
                    		+ System.getProperty("testPlan") + "'>"
                    		+ "http://excord.deem.com/testplan_view?testplanId="
                            + System.getProperty("testPlan")
                            + "</a></b></td></tr>"
                    		: "" )
                    + "<tr><td style='background-color: #ffffff;'><b>For more information <u><a href='DetailedTestResults.html"
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
        ...
        return new PrintWriter(new BufferedWriter(new FileWriter(new File(
                outdir, "EmailReport_TestResults.html"))));
    }
    ...
    public void generateSuiteSummaryReport(List<ISuite> suites) {
        try {
            ...
            //  Test Result Summary
            drawResultTable(m_out, passedTestCount,
                    failedTestCount, skippedTestCount);
